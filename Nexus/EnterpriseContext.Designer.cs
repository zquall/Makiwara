...
[assembly: EdmRelationshipAttribute("EnterpriseModel", "FK_Project_BudgetRequest1", "BudgetRequest", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(Nexus.BudgetRequest), "Project", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(Nexus.Project), true)]
...
namespace Nexus
{
    ...
    public partial class BudgetRequest : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("EnterpriseModel", "FK_Project_BudgetRequest1", "Project")]
        public EntityCollection<Project> Projects
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Project>("EnterpriseModel.FK_Project_BudgetRequest1", "Project");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Project>("EnterpriseModel.FK_Project_BudgetRequest1", "Project", value);
                }
            }
        }
    ...
    public partial class Project : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("EnterpriseModel", "FK_Project_BudgetRequest1", "BudgetRequest")]
        public BudgetRequest BudgetRequest
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<BudgetRequest>("EnterpriseModel.FK_Project_BudgetRequest1", "BudgetRequest").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<BudgetRequest>("EnterpriseModel.FK_Project_BudgetRequest1", "BudgetRequest").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<BudgetRequest> BudgetRequestReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<BudgetRequest>("EnterpriseModel.FK_Project_BudgetRequest1", "BudgetRequest");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<BudgetRequest>("EnterpriseModel.FK_Project_BudgetRequest1", "BudgetRequest", value);
                }
            }
        }
